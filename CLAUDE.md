...
- Users must select vision models explicitly (no defaults). The consensus model selector is disabled until 2+ vision models are chosen, and the analyze button is disabled until a consensus model is also selected.
